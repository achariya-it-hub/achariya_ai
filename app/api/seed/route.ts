...
export async function POST() {
  try {
    ...
    await prisma.user.createMany({
      data: [
        { id: "u1", name: "Athiyaman", email: "athiyaman@achariya.ai", password: "demo123", role: "manager", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Athiyaman", department: "Content & Media", title: "Content Manager", phone: "+91 98765 43210", joinDate: "2024-01-10", status: "active" },
        { id: "u2", name: "Bala", email: "bala@achariya.ai", password: "demo123", role: "admin", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Bala", department: "Engineering", title: "Technical Lead", phone: "+91 98765 43211", joinDate: "2024-01-10", status: "active" },
        { id: "u3", name: "Ramkumar", email: "ramkumar@achariya.ai", password: "demo123", role: "member", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Ramkumar", department: "Media Production", title: "Video Producer", phone: "+91 98765 43212", joinDate: "2024-03-15", status: "active" },
    ...
    await prisma.projectMember.createMany({
      data: [
        ...
        { projectId: "p2", userId: "u1" }, { projectId: "p2", userId: "u3" }, { projectId: "p2", userId: "u7" },
    ...
    await prisma.task.createMany({
      data: [
        ...
        { id: "t26", projectId: "p2", milestoneId: "m4", title: "Video Color Grading & Rough Cut", description: "Perform color correction and audio sync for video episode 1", status: "done", priority: "high", assigneeId: "u7", dueDate: "2025-06-25", order: 3, payout: 1200 },
        { id: "t27", projectId: "p7", title: "RBIQ Client Motion Graphics Short", description: "Design and animate 30-second promo graphic clip", status: "in-progress", priority: "medium", assigneeId: "u7", dueDate: "2025-07-15", order: 2, payout: 800 },
        ...
        // Scheduled 48 Video Works tasks according to the sheet
